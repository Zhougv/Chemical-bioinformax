...
def scaffold_split_tv(dataset, smiles_list, task_idx=None, null_value=0, frac_train=0.9, frac_valid=0.1, return_smiles=False):
    np.testing.assert_almost_equal(frac_train + frac_valid, 1.0)

    if task_idx is not None:
        # 过滤掉 task_idx 中的 null 值
    ...
    # 创建形式为 {scaffold_i: [idx1, idx2, ...]} 的字典
    all_scaffolds = {}
